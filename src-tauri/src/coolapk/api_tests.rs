...
async fn probe_all_write_endpoints_http_method() {
    ...
    assert!(
        get_ok >= 7,
        "至少 7 个 GET 写接口应可用（like/unlike/reply/follow/unfollow/createFeed/msgSend），实际 {}",
        get_ok
    );
    assert!(
        post_bad >= 7,
        "对应的 POST 应全部返回请求方式错误，实际 {}",
        post_bad
    );
    assert!(
        both_bad >= 3,
        "登录接口应全部废弃（account/login, sendVcode, loginByMobile），实际 {}",
        both_bad
    );
}
...
async fn probe_readonly_endpoints_smoke() {
    ...
    let read_cases: &[(&str, &str, &[(&str, String)])] = &[
        ...
        (
            ...
            "/v6/page/dataList",
            &[
                ("url", "/page?url=V11_FIND_GOOD_GOODS_HOME".to_string()),
                ("page", "1".to_string()),
            ],
        ),
        (
        ...
        (
            "用户关注列表",
            "/v6/user/followList",
            &[("uid", "10086".to_string()), ("page", "1".to_string())],
        ),
        (
            "用户关注节点",
            "/v6/user/customNodeList",
            &[("uid", "10086".to_string())],
        ),
        // === 话题 ===
        (
        ...
        (
            "话题中心",
            "/v6/topic/tagList",
            &[("sort", "hot".to_string()), ("page", "1".to_string())],
        ),
        // === 应用 & 游戏 ===
        (
            "应用详情",
            "/v6/apk/detail",
            &[("id", "com.coolapk.market".to_string())],
        ),
        (
            "应用榜单",
            "/v6/page/dataList",
            &[
                ("url", "#/apk/rankList".to_string()),
                ("page", "1".to_string()),
            ],
        ),
        (
            ...
            "/v6/page/dataList",
            &[
                ("url", "#/game/gameRankList".to_string()),
                ("page", "1".to_string()),
            ],
        ),
        // === 通知 & 消息（需要登录，仅验证接口可达） ===
        ...
        (
            "@我通知",
            "/v6/notification/atme",
            &[("page", "1".to_string())],
        ),
        (
            "评论通知",
            "/v6/notification/comment",
            &[("page", "1".to_string())],
        ),
        (
            "点赞通知",
            "/v6/notification/like",
            &[("page", "1".to_string())],
        ),
        (
            "动态点赞通知",
            "/v6/notification/feedlike",
            &[("page", "1".to_string())],
        ),
...
async fn probe_all_documented_endpoints_from_collect() {
    ...
    let cases: &[(&str, &str, &[(&str, String)])] = &[
        ...
        (
            "应用游戏V7",
            "/v6/apk/index",
            &[("apkType", "1".to_string()), ("page", "1".to_string())],
        ),
        ...
        (
            "应用吧V7",
            "/appForum/list",
            &[("type", "default".to_string()), ("page", "1".to_string())],
        ),
        (
            "发现频道V7",
            "/discovery/index",
        ...
        (
            "应用圈V7",
            "/topic/feedList",
            &[("type", "all".to_string()), ("page", "1".to_string())],
        ),
        (
            "全站V7",
        ...
        (
            "话题动态",
            "/v6/topic/tagFeedList",
            &[("tag", "酷安".to_string()), ("page", "1".to_string())],
        ),
        (
            "话题中心",
            "/v6/topic/tagList",
        ...
        match client.api_get(path, params).await {
            Ok(res) => {
                ...
                let is_redirect = message_str.starts_with("https://")
                    ...
                    || error_code == Some(-10001);
                let is_forbidden = message_str.contains("无法访问") || error_code == Some(-3);
                let is_deprecated_msg =
                    message_str == "API unsupported." || message_str.contains("已下线");
...
async fn probe_extra_endpoints_from_web() {
    ...
    let cases: &[(&str, &str, &[(&str, String)])] = &[
        ...
        (
            ...
            "/v6/page/dataList",
            &[
                ("url", "V9_HOME_TAB_RANKING".to_string()),
                ("page", "1".to_string()),
            ],
        ),
        (
        ...
        (
            ...
            "/v6/page/dataList",
            &[
                ("url", "V8_HUODONG_XIANLIAO_20210523".to_string()),
                ("page", "1".to_string()),
            ],
        ),
        (
        ...
        (
            ...
            "/v6/page/dataList",
            &[
                ("url", "V13_IOSHOME_OPENSHOW".to_string()),
                ("page", "1".to_string()),
            ],
        ),
        (
            ...
            "/v6/page/dataList",
            &[
                ("url", "V13_HOME_SHEYING".to_string()),
                ("page", "1".to_string()),
            ],
        ),
        (
        ...
        (
            "V8外设页",
            "/v6/page/dataList",
            &[("url", "V14_WAISHE".to_string()), ("page", "1".to_string())],
        ),
        (
            "V8视频页",
            "/v6/page/dataList",
            &[
                ("url", "V9_HOME_TAB_SHIPIN".to_string()),
                ("page", "1".to_string()),
            ],
        ),
        (
            ...
            "/v6/page/dataList",
            &[
                ("url", "V9_HOME_TAB_WENDA".to_string()),
                ("page", "1".to_string()),
            ],
        ),
        (
        ...
        (
            ...
            "/v6/page/dataList",
            &[
                ("url", "V11_FIND_COOLPIC".to_string()),
                ("page", "1".to_string()),
            ],
        ),
        (
        ...
        (
            ...
            "/v6/page/dataList",
            &[
                ("url", "V8_ZHUANTI_HOT_20201215".to_string()),
                ("page", "1".to_string()),
            ],
        ),
        (
            ...
            "/v6/page/dataList",
            &[
                ("url", "V11_DISCOVERY_SECOND_HAND".to_string()),
                ("page", "1".to_string()),
            ],
        ),
        (
        ...
        (
            ...
            "/v6/page/dataList",
            &[
                ("url", "V10_DIGITAL_HOME".to_string()),
                ("page", "1".to_string()),
            ],
        ),
        (
        ...
        (
            ...
            "/v6/page/dataList",
            &[
                ("url", "V8_ZHUANTI_COMPUTER_20230413".to_string()),
                ("page", "1".to_string()),
            ],
        ),
        (
            ...
            "/v6/page/dataList",
            &[
                ("url", "V11_ZHUANTI_EARPHONE".to_string()),
                ("page", "1".to_string()),
            ],
        ),
        (
            ...
            "/v6/page/dataList",
            &[
                ("url", "V10_CHANNEL_SMB_TOP".to_string()),
                ("page", "1".to_string()),
            ],
        ),
        (
        ...
        (
            ...
            "/v6/page/dataList",
            &[
                ("url", "V9_HOME_TAB_LIVE".to_string()),
                ("page", "1".to_string()),
            ],
        ),
        // === 用户子类型端点 ===
        ...
        (
            "主页V8关注",
            "/v6/main/indexV8",
            &[("type", "follow".to_string()), ("page", "1".to_string())],
        ),
        (
            "主页V8话题",
            "/v6/main/indexV8",
            &[("type", "topic".to_string()), ("page", "1".to_string())],
        ),
        // === 数码产品类别 ===
        (
            "产品问答",
        ...
        (
            "话题中心(最新)",
            "/v6/topic/tagList",
            &[("sort", "new".to_string()), ("page", "1".to_string())],
        ),
        (
            "话题中心(关注)",
            "/v6/topic/tagList",
            &[("sort", "follow".to_string()), ("page", "1".to_string())],
        ),
        ...
        (
            ...
            "/v6/page/dataList",
            &[
                ("url", "#/feed/statHotList?period=7d".to_string()),
                ("page", "1".to_string()),
            ],
        ),
    ];
...
async fn probe_more_endpoints_deep() {
    ...
    let cases: &[(&str, &str, &[(&str, String)])] = &[
        ...
        (
            ...
            "/v6/page",
            &[
                ("url", "V9_HOME_TAB_HEADLINE".to_string()),
                ("page", "1".to_string()),
            ],
        ),
        (
        ...
        (
            ...
            "/v6/page",
            &[
                ("url", "V11_DIGITAL_PRODUCT_LIST".to_string()),
                ("page", "1".to_string()),
            ],
        ),
        ...
        (
            "游戏索引V7",
            "/v6/apk/index",
            &[("apkType", "2".to_string()), ("page", "1".to_string())],
        ),
        // === 搜索补充类型 ===
        (
            "搜索动态按时间",
            ...
            &[
                ...
                ("searchValue", "手机".to_string()),
                ("page", "1".to_string()),
                ("sortType", "dateline_desc".to_string()),
            ],
        ),
        (
            "搜索动态按热度",
        ...
        (
            ...
            "/v6/page/dataList",
            &[
                ("url", "/user/dyhSubscribe".to_string()),
                ("page", "1".to_string()),
            ],
        ),
        ...
        (
            ...
            "/v6/page/dataList",
            &[
                ("url", "/product/categoryList".to_string()),
                ("page", "1".to_string()),
            ],
        ),
...
async fn probe_api2_and_static_endpoints() {
    ...
    let static_urls = &[
        (
            "avatar.coolapk.com",
            "http://avatar.coolapk.com/data/000/53/63/81_avatar_middle.jpg",
        ),
        (
            "image.coolapk.com",
        ...
        (
            "static.coolapk.com",
            "https://static.coolapk.com/hotfix/v11/videoParser_2012040.jar",
        ),
    ];
...
async fn probe_undocumented_endpoints() {
    ...
    let cases: &[(&str, &str, &[(&str, String)])] = &[
        ...
        (
            "收藏列表",
            "/v6/favorite/list",
            &[("type", "feed".to_string()), ("page", "1".to_string())],
        ),
        (
            "收藏应用列表",
            "/v6/favorite/list",
            &[("type", "apk".to_string()), ("page", "1".to_string())],
        ),
        // === 专辑（应用集） ===
        ...
        (
            "应用集列表",
            "/v6/album/list",
            &[("page", "1".to_string()), ("listType", "hot".to_string())],
        ),
        (
            "应用集搜索",
            "/v6/album/search",
            &[("q", "工具".to_string()), ("page", "1".to_string())],
        ),
        (
            "应用集评论",
            "/v6/album/replyList",
            &[("id", "1".to_string()), ("page", "1".to_string())],
        ),
        // === 头条 ===
        (
            "头条列表",
        ...
        (
            "头条数量",
            "/v6/main/checkHeadlineCount",
            &[("firstItem", "0".to_string())],
        ),
        (
            "更新列表",
            "/v6/main/updateList",
        ...
        (
            "编辑精选",
            "/v6/feed/editorChoiceList",
            &[("page", "1".to_string())],
        ),
        // === 用户子类型 ===
        (
            "用户发现",
            "/v6/user/discoveryList",
            &[("uid", "10086".to_string()), ("page", "1".to_string())],
        ),
        (
            "用户应用集",
        ...
        (
            "用户图片",
            "/v6/picture/userPictures",
            &[("uid", "10086".to_string()), ("page", "1".to_string())],
        ),
        (
            "图片列表(标签)",
            "/v6/picture/list",
            &[("tag", "手机".to_string()), ("page", "1".to_string())],
        ),
        // === APK搜索(开发者) ===
        (
            "搜索开发者",
        ...
        (
            ...
            "/v6/apk/giftList",
            &[
                ("apkId", "com.coolapk.market".to_string()),
                ("page", "1".to_string()),
            ],
        ),
...
async fn probe_album_reply_chain() {
    ...
    println!(
        "album_id={album_id}, detail={}",
        clip(&detail.to_string(), 500)
    );
...
async fn probe_uwp_collected_endpoints() {
    ...
    let cases: Vec<Case> = vec![
        ...
        Case(
            ...
            vec![("id", coll_id.clone())],
        ),
        Case(
            "收藏单列表",
            "/v6/collection/list",
            vec![("uid", "10086".to_string()), ("page", "1".to_string())],
        ),
        Case(
            "收藏单内容",
            "/v6/collection/itemList",
            vec![("id", coll_id.clone()), ("page", "1".to_string())],
        ),
        // === 动态扩展 ===
        Case(
            "修改历史",
            "/v6/feed/changeHistoryList",
            vec![("id", feed_id.clone())],
        ),
        Case(
            "转发列表",
            "/v6/feed/forwardList",
        ...
        Case(
            "话题搜索",
            "/v6/feed/searchTag",
            vec![("q", "手机".to_string()), ("page", "1".to_string())],
        ),
        // === 问答 / 投票 ===
        Case(
            "问答列表",
        ...
        Case(
            "投票评论",
            "/v6/vote/commentList",
            vec![("fid", feed_id.clone()), ("page", "1".to_string())],
        ),
        // === 话题 ===
        Case(
            "话题设备动态",
        ...
        Case(
            "浏览历史",
            "/v6/user/hitHistoryList",
            vec![("page", "1".to_string())],
        ),
        Case(
            "最近历史",
            "/v6/user/recentHistoryList",
            vec![("page", "1".to_string())],
        ),
        Case(
            "用户搜索",
            "/v6/user/search",
            vec![("q", "小编".to_string()), ("page", "1".to_string())],
        ),
        // === 搜索扩展 ===
        Case(
            "搜索联想(app)",
        ...
        Case(
            "产品详情(name)",
            "/v6/product/detail",
            vec![("name", "小米15 Ultra".to_string())],
        ),
        Case(
            "加载配置",
            "/v6/account/loadConfig",
            vec![("key", "my_page_card_config".to_string())],
        ),
    ];
    ...
    println!(
        "\n补充接口 ({total}):  {ok} 可用 · {need_auth} 需登录 · {blocked} 被拦截 · {deprecated} 已废弃",
        total = cases.len()
    );
    assert!(
        ok + need_auth >= 14,
...
async fn probe_new_write_endpoints() {
    ...
    for (name, path, params) in cases {
        ...
        match res {
            Ok(r) => {
                ...
                if status == 401
                    || clip_body.contains("你还没有登录")
                    || clip_body.contains("请先登录")
                {
                    println!("  [  ✓ 需登录 ] {name:24} HTTP {status} (接口存在，方法正确)");
                    exist += 1;
                } else if clip_body.contains("does not exists")
                    || clip_body.contains("API unsupported")
                    || clip_body.contains("已下线")
                {
    ...
    println!(
        "\n新增候选写接口 ({cases_len}): 存在 {exist} · 废弃 {deprecated} · 其他 {unknown}",
        cases_len = cases.len()
    );
}
...
async fn probe_dyh_square_endpoints() {
    let client = CoolapkClient::new();
    let token = client.auth.read().unwrap().get_app_token().unwrap();
    let cases: &[(&str, &str, &[(&str, String)])] = &[
        (
            "看看号发现A",
            "/v6/page/dataList",
        ...
        (
            ...
            "/v6/page/dataList",
            &[
                ("url", "/page?url=/user/dyhSubscribe".to_string()),
                ("page", "1".to_string()),
            ],
        ),
