...
use coolapk::commands::{
    ...
    get_device_feed_list, get_device_info, get_digest_feeds, get_discovery_config,
    get_discovery_page_data, get_download_version_list, get_dyh_detail, get_dyh_feeds,
    get_dyh_list, get_editor_choice_feeds, get_fans_user_list, get_favorite_list,
    get_feed_change_history, get_feed_detail, get_feed_forward_list, get_feed_like_list,
    get_feed_replies, get_follow_user_list, get_following_feeds, get_game_list, get_headline_feeds,
    get_hit_history, get_hot_feeds, get_hot_replies, get_hot_topics, get_ignore_list,
    get_image_data_url, get_index_v8_feeds, get_latest_feeds, get_limit_list, get_load_config,
    get_notification_count, get_notifications, get_picture_list, get_product_detail,
    get_product_detail_by_name, get_product_feeds, get_question_answers, get_rank_feeds,
    get_recent_history, get_reply_detail, get_search_suggestions, get_search_suggestions_app,
